...
function App() {
  ...
  return (
    <div className="app">
      ...
      <h1 className="title">
      <span className="strong">音乃瀬奏ちゃん</span><span className="plain">の</span><span className="nowrap">歌検索</span>
      </h1>
      ...
      <footer className="footer">
        ...
        ※当サイトは、音乃瀬奏さんの楽曲をファンが検索・閲覧しやすくすることを目的とした非公式のファンサイトです。  
        著作権に関しては、YouTubeの埋め込みサムネイルやリンクを通じて公式コンテンツへ誘導する形をとっており、コンテンツの無断転載・再配布等は行っておりません。  
        本サイトは収益目的ではなく、広告表示やマネタイズ等も一切行っていません。
        </div>
      </footer>
    </div>
  );
